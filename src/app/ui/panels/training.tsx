...
export default function Training() {
  return (
    <div className="snap-always snap-center" id="training">
      <div className="relative min-h-screen flex bg-brandGreen pb-20">
        <div className="container max-w-screen-xl mx-auto flex flex-col justify-center items-center text-4xl ">
          <div className="hidden md:flex mx-auto justify-center items-center w-full">
            <Carousel
              className="rounded-xl h-min w-3/4"
            ...
            >
              <Card
                ...
                location="Foyle Arena, Derry and Templemore Sports Complex, Derry"
                time="Tuesdays 8:30pm, Thursdays 6pm"
              />
              <Card
                image={{
          ...
          <div className="snap-y snap-mandatory grid grid-cols-1 place-items-center gap-6 overflow-y-scroll no-scrollbar justify-between w-full mx-auto my-6 px-6 max-h-screen md:hidden">
