...
export default function Home() {
  return (
    <div className="snap-always snap-start" id="home">
      <div className="relative min-h-screen max-h-screen flex bg-brandBlue flex-col justify-center items-center">
        <div className="container max-w-screen-xl h-screen mx-auto flex flex-col gap-8 justify-center items-center text-base ">
